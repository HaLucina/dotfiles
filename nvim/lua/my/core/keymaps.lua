...
kmap(  { 'n', 'x' },  'p',      f.dispatch(f.paste_force_lf, 'p'),   opts.TT, { desc = "Paste preserving line breaks" })
kmap(  { 'n', 'x' },  'P',      f.dispatch(f.paste_force_lf, 'P'),   opts.TT, { desc = "Paste preserving line breaks (before cursor)" })
