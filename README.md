...
#### settings.json
その「都合のいい時だけルールを盾にする」態度は、見せつけられる側としてはかなりモヤモヤしますよね。普段のズボラさや身勝手さを知っているだけに、「どの口が言ってるんだ」という反発心が生まれるのは当然です。

その現象に名前をつけるとしたら、いくつかの切り口で提案してみます。

---

### 1. 心理学・社会学的なニュアンス
* **「スポットライト正義感」**
    普段はルールを無視しているのに、自分が主役になれる（あるいは優位に立てる）瞬間だけ、スポットライトを浴びるように正義感を起動させる様子。
* **「マウント式コンプライアンス」**
    ルールの遵守が目的ではなく、相手を抑え込む（マウントをとる）ための武器として規則を持ち出す現象。

### 2. 皮肉を込めた造語
* **「インスタント聖人（セイント）現象」**
    お湯を注ぐ（気が向く）だけで、その場限りの「正しい人」を急造して演じること。
* **「ルール・ビュッフェ」**
    目の前にある規則の中から、自分にとって都合が良く、相手を攻撃しやすいものだけを「つまみ食い」する態度。
* **「後出し道徳（モラル）」**
    普段の不真面目さを棚に上げ、今この瞬間の状況に対してだけ道徳的優位に立とうとする卑怯さを表現。

### 3. 少しウィットに富んだ表現
* **「正義のサブスクリプション（無料期間中）」**
    普段はコスト（努力）を払って守る気などないのに、自分にメリットがある短い期間だけ「正義」を利用している状態。
* **「デコボコ規律」**
    自分には甘く（凹）、他人を叩くときだけ厳しく（凸）なる、一貫性のないルールの適用。

---

> **個人的な見解**
> こういう人は、ルールそのものを大切に思っているのではなく、**「ルールを使っている自分」の全能感**に酔っていることが多いですよね。
>
> 心理学的には「道徳的認可（Moral Licensing）」の歪んだ形とも言えます。「さっきまであんなに自由奔放に振る舞ったんだから、今はちょっと厳しくしてもいいだろう」という、本人なりの謎のバランス感覚（実際はただのワガママですが）が働いているのかもしれません。

もししっくりくるものがあれば、心の中でその人にラベルを貼っておくと、少しだけ客観的に（あるいは冷ややかに）眺められるようになるかもしれませんね。
